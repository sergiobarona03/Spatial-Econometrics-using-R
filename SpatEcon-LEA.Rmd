...
-   Los datos analizados son de la Distribución espacial de NBI.
...
-   **Respuesta: Dependencia espacial**
    ...
    ii. **Autocorrelación espacial**. Las áreas vecinas son similares. Tobler, W. R (1970). "A computer movie simulating urban growth in the Detroit region." Economic Geography 46(2).

    <!-- -->

    ii. Las áreas de observación son generalmente de diferentes tamaños. Heterogeneidad $\rightarrow$ Heterocedasticidad.

<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\leyNewton.png){#id .class width="65%" height="65%"}</center>
...
<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\imagen6.png){.class width="100%" height="85%"}</center>
...
<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\fig_mat_ones.png){.class width="70%" height="70%"}</center>
...
<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\fig_mat_w.png){.class width="70%" height="70%"}</center>
...
<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\fig_mat_wij.png){.class width="70%" height="70%"}</center>
...
<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\imagen1.png){.class width="70%" height="70%"}</center>
...
<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\imagen10.png){.class width="70%" height="70%"}</center>
...
moran.plot(dpto_merged$tasa_nbi, nb2_dpto, 
           zero.policy=T, labels=as.character(dpto_merged$DPTO),
...
AIC(model.lag.eig)    # 18.69224
AIC(model.err.eig)    # 25.15315

BIC(reg_mco)       # 44.76408
BIC(model.lag.eig)    # 39.99975
BIC(model.err.eig)    # 46.46066
...
AIC(model.lag.eig)    # 18.69224
AIC(model.err.eig)    # 25.15315
AIC(model.slx.eig)    # 17.64841
AIC(model.lag.error)    # 14.12242

BIC(reg_mco)       # 44.76408
BIC(model.lag.eig)    # 39.99975
BIC(model.err.eig)    # 46.46066
BIC(model.slx.eig)    # 49.60968
BIC(model.lag.error)    # 38.09337
...
<center>![](C:\Users\danie\OneDrive\Escritorio\Spatial-Econometrics-using-R\spatecon_images\imagen17.png){.class width="100%" height="85%"}</center>
