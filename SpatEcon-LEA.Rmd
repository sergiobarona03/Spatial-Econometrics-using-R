...
# Moran plot
mun_a_etiquetar <- c("CARTAGENA", "PANA PANA (ANM)", "GUADALAJARA DE BUGA", "RIOHACHA", "BARRANQUILLA","CALI","PUERTO COLOMBIA", "BUCARAMANGA", "ARAUCA" )

etiquetas <- ifelse(mun_merged$nom_mun %in% mun_a_etiquetar,
