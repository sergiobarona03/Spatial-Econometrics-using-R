...
- Diseño conjunto con \newline
- Sergio Barona, M.Sc. Coordinador Laboratorio de Economía Aplicada - LEA \newline
...
- **Respuesta: Dependencia espacial**
	...
	- **Autocorrelación espacial**. Las áreas vecinas son similares. Tobler, W. R (1970). "A computer movie simulanting urban growth in the Detroit region." Economic Geography 46(2). 
...
![](C:/Users/Portatil/Desktop/Spatial Econometrics using R/spatecon_images/mapa_bogota.png){#id .class width=65% height=65%}

![](C:/Users/Portatil/Desktop/Spatial Econometrics using R/spatecon_images/mapa_bogota_2.png){#id .class width=65% height=65%}
...
## Modelo Espacial Autorregresio combinado (SAC)
